...
if Enzyme == "CAS9":
    ...
    for seq in candidates:
        hits = seq[9] + seq[11]
        R2.write(seq[0] + "\t" + str(seq[1]) + "\t" + str(seq[2]) + "\t" + seq[3] + "\t"+ PAM(seq[3],seq[4]) + "\tNumber of Possible OffTargets = " + str(hits - 1) + "\n")
    ...
    if len(Multiple) > 0:
        ...
        for x in Multiple:
            if x[5] == "+":
                R2.write(x[0] + x[1] + "\t" + x[2] + "  " + "NGG" + "\tNumber of Possible OffTargets = " + str(x[3] - x[6] - 1) + "\n")
            if x[5] == "-":
                R2.write(x[0] + x[1] + "\t" + "CCN" + "  " + x[2] + "\tNumber of Possible OffTargets = " + str(x[3] - x[6] - 1) + "\n")
...
#############
    ...
    for seq in candidates:
        hits = seq[9] + seq[11]
        R2.write(seq[0] + "\t" + str(seq[1]) + "\t" + str(seq[2]) + "\t" + seq[3] + "\t"+ PAM12a(seq[3],seq[4]) + "\tNumber of Possible OffTargets = " + str(hits - 1) + "\n")
    ...
    for sg in candidates:
        ...
        if hits == 1:
            if sg[3] == "+":
                HITS = HITS + sg[0]+"\t"+str(sg[1])+"\t"+str(sg[2])+"\t"+sg[3]+"\t"+sg[4][:4]+" "+sg[4][4:]+"\n"
            if sg[3] == "-":
                HITS = HITS + sg[0]+"\t"+str(sg[1])+"\t"+str(sg[2])+"\t"+sg[3]+"\t"+sg[4][:20]+" "+sg[4][20:]+"\n"
            h = h +1
    ...
    if len(Multiple) > 0:
        ...
        for x in Multiple:
            if x[5] == "+":
                R2.write(x[0] + x[1] + "\t" + "TTTN" + "  " + x[2] + "\tNumber of Possible OffTargets = " + str(x[3] - x[6] - 1) + "\n")
            if x[5] == "-":
                R2.write(x[0] + x[1] + "\t" + x[2] + "  " + "NAAA" + "\tNumber of Possible OffTargets = " + str(x[3] - x[6] - 1) + "\n")
